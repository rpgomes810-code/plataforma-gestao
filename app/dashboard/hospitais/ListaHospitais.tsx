...
export default function ListaHospitais({ hospitais, membroLogado, podeCriar, podeEditar, podeExcluir }: {
  ...
  return (
    <div style={{ background: '#f1f5f9', minHeight: '100vh', padding: isMobile ? '16px' : '28px 40px' }}>
      <style>{`.hospital-row:hover { background: #f8fafc; }`}</style>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'flex-end' }}>
            <div style={{ flex: isMobile ? '1 1 100%' : '0 0 200px' }}>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: 1, marginBottom: 5 }}>CIDADE</label>
        ...
        <div style={{
          ...
          {!isMobile && (
            <div style={{
              ...
              <span style={{ fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: 1 }}>CIDADE</span>
          ...
          {filtrados.length === 0 ? (
            ...
            <div key={hospital.id} className="hospital-row" style={{
              ...
              {isMobile ? (
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p style={{ fontWeight: 700, color: '#0f172a', fontSize: 13, margin: '0 0 4px', textTransform: 'uppercase', letterSpacing: 0.4, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {hospital.nome}
                    </p>
                    <div style={{ display: 'flex', gap: 6, alignItems: 'center', flexWrap: 'wrap' }}>
                      ...
                      {hospital.cidade && (
                        <span style={{ fontSize: 11, color: '#94a3b8' }}>{hospital.cidade}</span>
                      )}
                    </div>
                  </div>
